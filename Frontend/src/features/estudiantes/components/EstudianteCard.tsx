                ...
                <Can permission="estudiantes.habilitar">
                    {isHabilitado ? (
                        <button
                            ...
                            className="inline-flex h-8 w-8 shrink-0 items-center justify-center rounded-full text-slate-600 hover:bg-rose-50 hover:text-rose-600 transition-colors"
                        ...
                        <button
                            ...
                            className="inline-flex h-8 w-8 shrink-0 items-center justify-center rounded-full text-slate-600 hover:bg-emerald-50 hover:text-emerald-600 transition-colors"
