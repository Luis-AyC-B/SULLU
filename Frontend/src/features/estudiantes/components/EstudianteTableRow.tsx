...
export function EstudianteTableRow({
    ...
    return (
        <TableRow className="hover:bg-slate-50/75 transition-colors border-b border-slate-100">
            ...
            {/* Columna: INHABILITAR (Acción protegida por permisos) */}
            <TableCell className="py-3.5 pr-5 text-right">
                <Can permission="estudiantes.habilitar">
                    {isHabilitado ? (
                        <button
                            type="button"
                            onClick={() => onInhabilitarClick(estudiante)}
                            className="inline-flex h-8 w-8 items-center justify-center rounded-full text-slate-600 hover:bg-rose-50 hover:text-rose-600 transition-colors"
                        ...
                        <button
                            ...
                            className="inline-flex h-8 w-8 items-center justify-center rounded-full text-slate-600 hover:bg-emerald-50 hover:text-emerald-600 transition-colors"
