                ...
                <div className="flex-1">
                    ...
                    <div className="relative">
                        <select
                            ...
                            onChange={(e) => onSelectExamen(Number(e.target.value))}
                            className="w-full appearance-none rounded-lg border border-slate-300 bg-white px-3.5 py-2.5 text-xs sm:text-sm font-medium text-slate-800 shadow-2xs focus:border-[#002D62] focus:outline-hidden focus:ring-1 focus:ring-[#002D62] transition-colors pr-10 cursor-pointer"
                        >
                            {examenes.map((examen) => (
